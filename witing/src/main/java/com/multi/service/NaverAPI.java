...
//			System.out.println("response body : "+result);
	        ...
	        userInfo.put("birth", naver_response.get("birthyear").toString().replaceAll("\"","")+"-"+naver_response.get("birthday").toString().replaceAll("\"", ""));
	        userInfo.put("gender", naver_response.get("gender").toString().replaceAll("\"","").equals("F")? "woman" : "man");
